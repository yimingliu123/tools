...
class RFDB(nn.Module):
	...
	self.c1_d = OctaveConv(in_channels*2 , in_channels*2 , 1)
        
	#self.c1_r = conv_layer(in_channels, self.rc, 3)
        #self.c2_d = conv_layer(self.remaining_channels, self.dc, 1)
        self.c2_d = OctaveConv(in_channels*2 , in_channels*2 , 1)
	
	#self.c2_r = conv_layer(self.remaining_channels, self.rc, 3)
        self.c3_d = conv_layer(self.remaining_channels, self.dc, 1)
        self.c3_d = OctaveConv(in_channels*2 , in_channels*2 , 1)
	#self.c3_r = conv_layer(self.remaining_channels, self.rc, 3)
        ...
        self.c5 = conv_layer(self.rc*4, in_channels, 1)
        self.esa = ESA(in_channels, nn.Conv2d)

    def forward(self, input):
        #distilled_c1 = self.act(self.c1_d(input))
	distilled_c1, r_c1 = self.c1_d(input)
        distilled_c1 = self.act(distilled_c1)
	#r_c1 = (self.c1_r(input))
        r_c1 = self.act(r_c1+input)

        #distilled_c2 = self.act(self.c2_d(r_c1))
        distilled_c2, r_c2 = self.c2_d(r_c1)
	distilled_c2 = self.act(distilled_c2)
	#r_c2 = (self.c2_r(r_c1))
        r_c2 = self.act(r_c2+r_c1)

        #distilled_c3 = self.act(self.c3_d(r_c2))
        distilled_c2, r_c2 = self.c2_d(r_c2)
	distilled_c3 = self.act(distilled_c3)
	#r_c3 = (self.c3_r(r_c2))
